...
$('.portfolio li > a').click(function(eventObject){
    $(".portfolio li").removeClass("active");
    $(this).closest("li").addClass('active');
    eventObject.preventDefault();
});

$('.popup-portfolio .close').click(function(eventObject){
    $(".portfolio li").removeClass("active");
    eventObject.preventDefault();
});
...
$('.container-order .buttons > a.btn').click(function(eventObject){
    $(this).closest(".container-order").addClass('active');
    eventObject.preventDefault();
});
